class Strings {
  ...
  static const String preferredAccount = "Tap to select your preferred account";
  static const String signIn = "Sign In";
  static const String howdy = "Howdy!";
  static const String selectAccount =
      "Kindly Select/Click the type of account\nyou want to create below";
  static const String userAction = "I want to Buy/Ship";
  static const String buyingAgent = "Buying Agent";
  static const String deliveryAgent = "Delivery Agent";
  static const String shippingAgent = "Shipping Agent";
