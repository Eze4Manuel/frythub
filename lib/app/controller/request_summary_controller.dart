...
class RequestSummaryController extends GetxController {
  ...
  TextEditingController textPickupDateController = new TextEditingController();
  TextEditingController textDeliveryDateController = new TextEditingController();
  ...
  void setPreferredPickupDate(value){
    textPickupDateController.text = value.toString();
  ...
  void setPreferredDeliveryDate(value){
    textDeliveryDateController.text = value.toString();
  ...
  void resetVariables (){
     ...
     _preferredPickupDate;
     _preferredDeliveryDate;
     textPickupDateController.text = '';
     textDeliveryDateController.text ='';
     textController.text =  '';
  }
}
